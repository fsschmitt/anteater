      ...
      <div className="py-2 w-screen fixed bg-blue-900 border-blue-800 z-10 border-b-1 border-t-0 border-r-0 border-l-0">
        <ul className="flex w-full mx-auto max-w-md">
          <li className="px-3 border-r">
            <NavLink activeClassName="text-blue-300" className="text-white hover:text-blue-800" to="/home">
              Fill hours
            </NavLink>
          </li>
          <li className="px-3">
            <NavLink activeClassName="text-blue-300" className="text-white hover:text-blue-800" to="/settings">
              Settings
            </NavLink>
          </li>
        </ul>
